...
<!-- Mirrored from dreamingtheme.kiendaotac.com/html/ysera/gridproducts_bannerslider.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 06 Mar 2025 07:39:01 GMT -->
<head>
    <title>Ysera - Products Grid Banner Slider</title>
    <meta charset="UTF-8">
                        ...
                        <div class="item-banner style1">
                            <div class="inner equal-element">
                                <div class="banner-content style1">
                                    <h4 class="ysera-subtitle">Start ur weekend off right!</h4>
                                    <h3 class="title">Flash Sale Up To<br/> 15% Off</h3>
                                    <span class="when-code">When Use Code: <span class="code">YSERA</span></span>
                        ...
                        <div class="item-banner style2">
                            <div class="inner equal-element">
                                <div class="banner-content style2">
                                    <h3 class="title">Plant Indoor</h3>
